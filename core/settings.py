...
"""
import os
# Tenta pegar a URL do Neon das variáveis de ambiente
DATABASE_URL = os.environ.get('DATABASE_URL')
# Se existir a variável DATABASE_URL (na Vercel), ele usa o Neon.
# Se não existir (no seu PC), ele usa o SQLite local.
